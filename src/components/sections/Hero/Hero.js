    ...
    <div className={styles.hero}>
      <div className={styles.contentContainer}>
        <div className={styles.mainContent}>
          ...
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing . Morbi vestibulum mi felis. Cras ac
            erat arcu.Vivamus sagittis augue ut bibendum mollis.Vivamus sagittis augue ut bibendum
            mollis.
          </p>
