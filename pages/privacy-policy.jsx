    ...
    <div className={S.policies}>
      ...
      <section className="intro">
        ...
        <p>
          ...
          accordance with the provisions of the applicable laws. In the course
          of our business and/or your engagement with us and third parties
          through our Platforms (this includes but are not limited to our
          websites, digital platforms, mobile applications, physical
          operations/offices, amongst others), we may process your Personal
          Data, subject however to the terms of this Policy. This Privacy Policy
          (“Policy”) explains our privacy practices concerning how we collect
      ...
      <section className="terms">
        ...
        <div>
          <div>
            ...
            bank details, posts on our Platforms, religion, date of birth,
            health, race/tribe, nationality, ethnicity, political views, trade
            union membership, criminal records, medical information, and other
            unique identifiers such as but not limited to MAC address, IP
            address, IMEI number, Bank Verification Number, IMSI number, SIM and
          ...
          <div>
            ...
            services only with the involvement of a parent or legal guardian,
      ...
      <section className={S.dataCollection}>
        ...
        <div>
          ...
          our Platforms, we may collect your Personal Data and non-Personal Data
          in the following ways:
          <ul>
            <li>
              <strong>Automatic Information collection:</strong> We may
              automatically collect Information upon your engagement with us or
              our Platforms through your computer, mobile phones, forms,
              documents made available to us and other access devices. The
              information sent includes, but is not limited to, data about our
              pages you access, geo-location information; statistics on page
              views; traffic to and from our Platforms.
            </li>
            <li>
              <strong>Information from downloads: </strong> When you download or
              use our digital Platforms or access our site, we may receive
              non-personal information from your mobile device about your
              location, number of downloads, geolocation of downloads. You may
              disable your location in the settings menu of the device.
            </li>
            <li>
              <strong>Physically or Digitally Provided Personal Data:</strong>
              We may collect and process your Personal Data when you create
              and/or update your account on our Platform; complete forms,
              questionnaires, surveys etc. We may also collect Personal Data
              from the information you provide to us through documents, letters,
              e-mail, agreements, correspondence, ID cards, passports, or
              through any other means by which you wilfully provide information
              to us. When you use Esportcave Services, we may also collect
              Personal Data about your transactions and your activities. In
              addition, when you open an account on our Platform, we may collect
              Personal Data such as your contact information, which includes
              your name, address, phone number, email or other similar
              information; financial information such as your full bank account
              numbers and/or credit card or debit card numbers.
            </li>
            <li>
              <strong>Third Parties: </strong> We may also receive your Personal
              Data from third parties such as, guardians, financial
              institutions, identity verification services, vendors, and service
              providers etc.
            </li>
            <li>
              <strong>Social Media: </strong> We also receive Personal Data
              through your engagements with us on social media sites (e.g.,
              Facebook, Instagram, LinkedIn, Twitter, etc). This includes but
              are not limited to your replies to our posts, your comments,
              enquiries, messages to us, etc. We may also collect Personal Data
      ...
      <section className="data-access">
        ...
        <div>
          ...
          <div>
            ...
            other personalized content. Most mobile devices allow you to control
            or disable location services in the device&#39;s setting menu. If
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              ...
              and send you information or request feedback about features on our
              website and applications or changes to our policies
            </li>{" "}
            <li>
              {" "}
              send you periodic emails and updates pertaining to our products
              and services
            </li>{" "}
            <li>
              {" "}
              verify customers’ identity, including during account creation and
            ...
            <li>
              {" "}
              conduct background checks, compare information for accuracy and
              verify same with third parties
            </li>{" "}
            <li>
              {" "}
              identify or address a violation and administer our policies and
              terms of use
            </li>{" "}
            <li>
              {" "}
            ...
            <li>
              {" "}
              execute your specific requests or use same for a specific purpose
              as you may instruct
            </li>{" "}
            <li>
            ...
            <li>
              {" "}
              process your access to our services, Platforms, or functions from
              time to time
            </li>
          </ul>
          <div>
      ...
      <section className="laws">
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              To perform a contract with you or to take steps at your request
              before entering into a contract
            </li>
            <li>
              If we have your consent for specific processing of your Personal
              Data for one or more specific purposes
            </li>
            <li>
              To use your Personal Data in our business interest to enable us to
      ...
      <section className="storage">
        ...
        <div>
          <div>
            ...
            Some of our safeguards include firewall protection, Virtual Private
            Network (VPN) protection, encryption of data, authorization keys for
            authorised access and strong passwords. Access to our various
            platforms is restricted to authorized users only. Your Personal Data
            is also stored on our secure servers as well as secure physical
          ...
          <div>
            ...
            Platforms are secure. We therefore strongly advise you to keep such
            information secure and confidential. If you use a third party’s
            device (laptops, phones, public internet, etc.) to access your
            account, kindly ensure that you always log out. Kindly note however,
            that certain devices are programmed to save passwords or usernames,
      ...
      <section className="processing">
        ...
        <div>
          <div>
            ...
            and billing address, or other information needed to complete the
            transaction. We also work with third parties, including financial
            institutions, vendors, service providers, who at one point or the
            other facilitate transactions executed on our Platforms. For
            completeness, in the course of your engagement with us or use of our
            services and Platforms, we may share your Personal Data with
            different stakeholders, including but not limited to Financial
            institutions; service providers; Credit bureaus and collection
            agencies to report account or credit information; Esportcave
            subsidiaries and affiliates; Regulatory or judicial authorities; or
        ...
        <div>
          ...
          <ul>
            <li>
              ...
              such information may be sent to <a href="#">[*]</a>.
            </li>
            <li>
              ...
              is too frequent, unreasonable, and likely to cause the substantial
        ...
        <div>
          ...
          <ol>
            <li>
              ...
              products, services, and communications. Members of the group will
              use this Personal Data to send you marketing communications and
              opportunities only if you have requested their services.
            </li>
            <li>
              {" "}
              Credit bureaus and collection agencies to report account or credit
            ...
            <li>
              ...
              Data. If your Personal Data could be used contrary to this policy,
            ...
            <li>
              ...
              requirement applicable to Esportcave or one of its agents; when we
              need to do so to comply with law; or when we believe, in our sole
              discretion, that the disclosure of Personal Data is necessary to
          ...
          <ol>
            ...
            <li>
              Service Providers: to enable service providers under contract with
              us to support our business operations, such as fraud prevention,
              marketing, customer service and technology services. Our contracts
              dictate that these service providers only use your Personal Data
              in connection with the services they perform for us and not for
              their own benefit.
            </li>
          </ol>
        </div>
      ...
      <section className="cross-border">
        ...
        <div>
          ...
          Esportcave is committed to adequately protecting your Personal Data
      ...
      <section className="data-breach">
        ...
        <div>
          ...
          to our Platforms and shall within 72 (Seventy-Two) hours of having
          knowledge of such breach report the details of the breach to NITDA.
      ...
      <section className="resolution">
        ...
        <div>
          ...
          your name and details of your complaint. Upon receipt of your
          complaint, we will endeavor to contact you within 3 (three) working
          days with a view to amicably resolving such dispute within the
          shortest possible time. The foregoing notwithstanding, all disputes
          arising from this policy shall first be resolved by negotiation.
